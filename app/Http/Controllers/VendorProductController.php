...
class VendorProductController extends Controller
{
    public function index()
    {
        ...
        return view('vendor_products.index', ['products' => $products]);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('vendor_products.index', ['vendorProducts' => $vendorProducts]);
    }
    ...
    public function showAllData()
    {
        ...
        return view('vendor_products.all', compact('vendorProducts'));
    }
    ...
    public function show($id)
    {
        ...
        return view('vendor_products.show', ['vendorProduct' => $vendorProduct]);
    }
    ...
    {
        return view('vendor_products.create');
    }
