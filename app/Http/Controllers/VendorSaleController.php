...
class VendorSaleController extends Controller
{
    ...
    public function index()
    {
        ...
        $vendor_id = $vendor->id;
        $vendor_orders = Order::where('user_id', $vendor_id)->get();
        return view('vendor_sales.index', compact('vendor_orders', 'vendor'));
    }
    ...
    public function usercheck()
    {
        $mobile_number = null;
        $users = User::all();
        return view('vendor_sales.usercheck', compact('users', 'mobile_number'));
    ...
    public function check(Request $request)
    {
        ...
        if($customer){
            $productQuery = DB::table('inventories')
                ...
                return view('vendor_sales.create', compact('prods', 'customer'));
        }else{
            $user = new User([
                'name' => "Tourist",
        ...
        return redirect()->route('vendor_sales.create', compact('prods', 'customer'))->with('success', 'User created successfully');
}
    ...
    public function addtocart(Request $request)
{
    ...
    public function cart()
    {
        ...
        return view('vendor_sales.cart', compact('vendor_cart', 'customer', 'prods'));
    }
    ...
    public function removefromcart($id)
    {
        ...
        $ref = Session::get('ref');
        $prods = Session::get('prods');
        return view('vendor_sales.create', compact('prods', 'customer', 'ref'));
    }
    ...
    public function checkout()
    {
        ...
        $vendor_cart = VendCart::where('customer_id', $customer->id)
                        ...
                        ->whereNull('deleted_at')
                        ->whereNull('order_id')->get();
        return view('vendor_sales.checkout', compact('vendor_cart', 'customer', 'ref', 'prods'));
    }
}
