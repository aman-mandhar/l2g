...
class InventoryController extends Controller
{
    ...
    public function addstock()
    {
        ...
        return view('inventories.addstock', compact('products'));
    }
    ...
    public function addnewstock(Request $request)
    {
        ...
        return view('inventories.addnewstock', compact('product'));   
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('inventories.details', $inventory->id);
    ...
    public function details($id)
    {
        ...
        return view('inventories.details', compact('inventory', 'product', 'productCategory', 'productSubcategory', 'productVariation'));
    }
