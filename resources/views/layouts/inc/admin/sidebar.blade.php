  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#auth">
          ...
          <span class="menu-title">Sale Orders</span>
          <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link normal-navigation" href="{{ route('orders.index') }}"> List of Sale Orders </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href="{{ route('sales.usercheck') }}"> New Sale </a></li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link normal-navigation" href="{{ route('purchases.create') }}"> New Purchase Order </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href="{{ route('purchases.index') }}"> Purchase Order List </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href="{{ route('sales.index') }}"> Stock List </a></li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link normal-navigation" href=""> Referral Points </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href=""> Customer Points </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href=""> Business Points </a></li>
              <li class="nav-item"> <a class="nav-link normal-navigation" href=""> Adjust </a></li>
          </ul>
      </div>
    </li>
  </ul>
